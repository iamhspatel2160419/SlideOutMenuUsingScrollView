...
class ProductLine
{
    ...
    private class func iDevices() -> ProductLine {
        ...
        products.append(Product(titled: "iPad", description: "iPad Air 2 is the thinnest and most powerful iPad ever. With iPad, weâ€™ve always had a somewhat paradoxical goal: to create a device thatâ€™s immensely powerful, yet so thin and light you almost forget itâ€™s there.", imageName: "ipad-air2"))
        ...
        products.append(Product(titled: "iOS", description: "iOS is the worldâ€™s most advanced operating system. Its easy-to-use interface, amazing features, and rock-solid stability are built into every iPhone, iPad, and iPod touch.", imageName: "iOS8"))
    ...
    private class func software() -> ProductLine
    {
        ...
        products.append(Product(titled: "Final Cut Pro X", description: "A revolutionary new version of the worldâ€™s most popular Pro video editing software which completely reinvents video editing.", imageName: "final-cut-pro-x"))
    ...
    private class func iPod() -> ProductLine
    {
        ...
        products.append(Product(titled: "Apple TV", description: "Access to tons of great HD content in a tiny package. Enjoy blockbuster movies, TV shows, live sports and news, your music, photos, and more â€” right on your high-definition TV.", imageName: "apple-tv"))
